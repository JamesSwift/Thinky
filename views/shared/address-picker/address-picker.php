...
<div class="create search">
    ...
    <p class="extra check display-none">We found the following address. Please check it over and add any missing information.</p>
    <form>
    <table>
        <tr>
        ...
        <tr>
    	    <td>Country *</td>
    	    <td>      
                <select class="country" data-required='true' autocomplete='country-name' name="country">
                ...
                Rothesay    <option value="Kazakhstan">Kazakhstan</option>
	...
	<div class="search">
		...
		<a class="manualLink" href="javascript:;"/>Enter address manually</a>
		<br/>
	</div>
	<table class="extra">
		<tr>
	...
	<input type='button' value='Save Address' class="add extra" />
    </form>	
	<p class="results"></p>
</div>